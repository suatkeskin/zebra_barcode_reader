...
public class Messages {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static final class BarcodeReaderDto {
    ...
    public boolean equals(Object o) {
      if (this == o) { return true; }
      if (o == null || getClass() != o.getClass()) { return false; }
      BarcodeReaderDto that = (BarcodeReaderDto) o;
    ...
    public static final class Builder {
      ...
      public @NonNull BarcodeReaderDto build() {
        BarcodeReaderDto pigeonReturn = new BarcodeReaderDto();
    ...
    static @NonNull BarcodeReaderDto fromList(@NonNull ArrayList<Object> pigeonVar_list) {
      BarcodeReaderDto pigeonResult = new BarcodeReaderDto();
  ...
  private static class PigeonCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte) 130:
          return BarcodeReaderDto.fromList((ArrayList<Object>) readValue(buffer));
        default:
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value) {
      ...
      } else if (value instanceof BarcodeReaderDto) {
        stream.write(130);
        writeValue(stream, ((BarcodeReaderDto) value).toList());
      } else {
